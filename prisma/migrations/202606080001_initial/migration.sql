...
CREATE TYPE "EventType" AS ENUM ('FALL', 'INACTIVITY', 'DISCONNECT', 'OUT_OF_RANGE', 'LOW_BATTERY');
...
CREATE INDEX "gateways_owner_user_id_idx" ON "gateways"("owner_user_id");
...
CREATE INDEX "events_gateway_id_timestamp_idx" ON "events"("gateway_id", "timestamp");
